...
module.exports = {
    ...
    viewMahasiswa: async (req, res) => {
        try {
            ...
            res.render("index", {
                mahasiswa,
                alert,
                title: "CRUD Mahasiswa", // Untuk title dari aplikasi kita, saya manamakannya dengan CRUD
            });
        } catch (error) {
    ...
    addMahasiswa: async (req, res) => {
        ...
        try {
            // Membuat contanta untuk nama, npm, jurusan, dan alamat yang diambil dari body/yang diketikan di form
            const { nama, npm, jurusan, alamat } = req.body;
            // lalu mengembalikan fungsi dan membuat data dari scheme/model Mahasiswa
            await Mahasiswa.create({ nama, npm, jurusan, alamat });
    ...
    editMahasiswa: async (req, res) => {
        try {
            ...
            const { id, nama, npm, jurusan, alamat } = req.body;
